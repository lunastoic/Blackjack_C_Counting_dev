 ...
 * Luna Luxe) in Training Mode; the in-game globe switches maps and modes.
...
export default function BootRedirect() {
  ...
  return <Redirect href={{ pathname: '/game/[mapId]', params: { mapId: String(bestMapId), mode: 'training' } }} />;
}
